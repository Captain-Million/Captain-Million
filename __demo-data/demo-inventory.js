...
const documents = [{
  ...
  act: 'dispatch',
  content: [{ name: products[1].name, quantity: 1 }],
  lastEdit: { user: demoUser._id, date: new Date(2017, 0, 17, 12, 17) },
}, {
  _id: '58c7a529b7b2bcc39adc5709',
  act: 'inventory',
  content: [
    { name: products[4].name, quantity: 5 },
    { name: products[6].name, quantity: 3 },
  ],
  ...
  act: 'arrival',
  content: [
    { name: products[4].name, quantity: 7 },
    { name: products[6].name, quantity: 1 },
  ],
  ...
  act: 'dispatch',
  content: [
    { name: products[4].name, quantity: 2 },
    { name: products[6].name, quantity: 4 },
  ],
